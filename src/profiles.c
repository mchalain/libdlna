...
static const mime_type_t mime_type_list[] = {
  /* Video files */
  { "asf",   {.mime = MIME_VIDEO_ASF, .media_class = DLNA_CLASS_AV,}},
  { "avc",   {.mime = MIME_VIDEO_AVI, .media_class = DLNA_CLASS_AV,}},
  { "avi",   {.mime = MIME_VIDEO_AVI, .media_class = DLNA_CLASS_AV,}},
  { "dv",    {.mime = "video/x-dv", .media_class = DLNA_CLASS_AV,}},
  { "divx",  {.mime = MIME_VIDEO_AVI, .media_class = DLNA_CLASS_AV,}},
  { "wmv",   {.mime = MIME_VIDEO_WMV, .media_class = DLNA_CLASS_AV,}},
  { "mjpg",  {.mime = "video/x-motion-jpeg", .media_class = DLNA_CLASS_AV,}},
  { "mjpeg", {.mime = "video/x-motion-jpeg", .media_class = DLNA_CLASS_AV,}},
  { "mpeg",  {.mime = MIME_VIDEO_MPEG, .media_class = DLNA_CLASS_AV,}},
  { "mpg",   {.mime = MIME_VIDEO_MPEG, .media_class = DLNA_CLASS_AV,}},
  { "mpe",   {.mime = MIME_VIDEO_MPEG, .media_class = DLNA_CLASS_AV,}},
  ...
  { "m1v",   {.mime = MIME_VIDEO_MPEG, .media_class = DLNA_CLASS_AV,}},
  { "m2v",   {.mime = MIME_VIDEO_MPEG_2, .media_class = DLNA_CLASS_AV,}},
  { "mpg2",  {.mime = MIME_VIDEO_MPEG_2, .media_class = DLNA_CLASS_AV,}},
  { "mpeg2", {.mime = MIME_VIDEO_MPEG_2, .media_class = DLNA_CLASS_AV,}},
  { "m4v",   {.mime = MIME_VIDEO_MPEG_4, .media_class = DLNA_CLASS_AV,}},
  { "m4p",   {.mime = MIME_VIDEO_MPEG_4, .media_class = DLNA_CLASS_AV,}},
  { "mp4",   {.mime = MIME_VIDEO_MPEG_4, .media_class = DLNA_CLASS_AV,}},
  { "mp4ps", {.mime = "video/x-nerodigital-ps", .media_class = DLNA_CLASS_AV,}},
  { "ts",    {.mime = MIME_VIDEO_MPEG_2, .media_class = DLNA_CLASS_AV,}},
  ...
  { "mov",   {.mime = MIME_VIDEO_QT, .media_class = DLNA_CLASS_AV,}},
  { "hdmov", {.mime = MIME_VIDEO_QT, .media_class = DLNA_CLASS_AV,}},
  { "qt",    {.mime = MIME_VIDEO_QT, .media_class = DLNA_CLASS_AV,}},
  { "bin",   {.mime = MIME_VIDEO_MPEG_2, .media_class = DLNA_CLASS_AV,}},
  { "iso",   {.mime = MIME_VIDEO_MPEG_2, .media_class = DLNA_CLASS_AV,}},

  /* Audio files */
  { "3gp",  {.mime = MIME_AUDIO_3GP, .media_class = DLNA_CLASS_AUDIO,}},
  { "aac",  {.mime = MIME_AUDIO_AAC, .media_class = DLNA_CLASS_AUDIO,}},
  { "ac3",  {.mime = MIME_AUDIO_AC3, .media_class = DLNA_CLASS_AUDIO,}},
  ...
  { "mp3",  {.mime = MIME_AUDIO_MPEG, .media_class = DLNA_CLASS_AUDIO,}},
  { "m4a",  {.mime = MIME_AUDIO_MPEG_4, .media_class = DLNA_CLASS_AUDIO,}},
  { "ogg",  {.mime = MIME_AUDIO_OGG, .media_class = DLNA_CLASS_AUDIO,}},
  { "wav",  {.mime = MIME_AUDIO_WAV, .media_class = DLNA_CLASS_AUDIO,}},
  { "pcm",  {.mime = MIME_AUDIO_LPCM, .media_class = DLNA_CLASS_AUDIO,}},
  { "lpcm", {.mime = MIME_AUDIO_LPCM, .media_class = DLNA_CLASS_AUDIO,}},
  { "l16",  {.mime = MIME_AUDIO_LPCM, .media_class = DLNA_CLASS_AUDIO,}},
  { "wma",  {.mime = MIME_AUDIO_WMA, .media_class = DLNA_CLASS_AUDIO,}},
  ...
  { "jpeg", {.mime = MIME_IMAGE_JPEG, .media_class = DLNA_CLASS_IMAGE,}},
  { "jpg",  {.mime = MIME_IMAGE_JPEG, .media_class = DLNA_CLASS_IMAGE,}},
  { "jpe",  {.mime = MIME_IMAGE_JPEG, .media_class = DLNA_CLASS_IMAGE,}},
  { "pcd",  {.mime = "image/x-ms-bmp", .media_class = DLNA_CLASS_IMAGE,}},
  { "png",  {.mime = MIME_IMAGE_PNG, .media_class = DLNA_CLASS_IMAGE,}},
