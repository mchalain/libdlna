...
upnp_service_variable_t rcs_service_variables[] = {
  { RCS_VAR_LAST_CHANGE, E_STRING, 0},
  { RCS_VAR_PRESET_NAME_LIST, E_STRING, 0},
  { RCS_VAR_BRIGHTNESS, E_UI2, 0},
  { RCS_VAR_CONTRAST, E_UI2, 0},
  { RCS_VAR_SHARPNESS, E_UI2, 0},
  { RCS_VAR_RED_VIDEO_GAIN, E_UI2, 0},
  { RCS_VAR_GREEN_VIDEO_GAIN, E_UI2, 0},
  { RCS_VAR_BLUE_VIDEO_GAIN, E_UI2, 0},
  { RCS_VAR_RED_VIDEO_BLACK_LEVEL, E_UI2, 0},
  { RCS_VAR_GREEN_VIDEO_BLACK_LEVEL, E_UI2, 0},
  { RCS_VAR_BLUE_VIDEO_BLACK_LEVEL, E_UI2, 0},
  { RCS_VAR_COLOR_TEMPERATURE, E_UI2, 0},
  { RCS_VAR_HORIZONTAL_KEYSTONE, E_I2, 0},
  { RCS_VAR_VERTICAL_KEYSTONE, E_I2, 0},
  { RCS_VAR_MUTE, E_BOOLEAN, 0},
  { RCS_VAR_VOLUME, E_UI2, 0},
  { RCS_VAR_VOLUME_DB, E_I2, 0},
  { RCS_VAR_LOUDNESS, E_BOOLEAN, 0},
  { RCS_VAR_ALLOWED_TRANSFORM_SETTINGS, E_STRING, 0},
  { RCS_VAR_TRANSFORM_SETTINGS, E_STRING, 0},
  { RCS_VAR_ALLOWED_DEFAULT_TRANSFORM_SETTINGS, E_STRING, 0},
  { RCS_VAR_DEFAULT_TRANSFORM_SETTINGS, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_CHANNEL, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_INSTANCE_ID, E_UI4, 0},
  { RCS_VAR_A_ARG_TYPE_PRESET_NAME, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_DEVICE_UDN, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_SERVICE_TYPE, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_SERVICE_ID, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_STATE_VARIABLE_VALUE_PAIRS, E_STRING, 0},
  { RCS_VAR_A_ARG_TYPE_STATE_VARIABLE_LIST, E_STRING, 0},
  { NULL, 0, 0}, 
};
